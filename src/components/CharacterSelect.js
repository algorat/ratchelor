...
class CharacterSelect extends React.Component {
  ...
  render() {
    ...
    if (this.state.ratSelected) {
      buttonArea = <div id="button-container">
      <button 
      ...
      buttonArea =  <div id="ratchelor-intro-question">
    ...
    return (
      <div id="custom-character" className="screen">
        ...
        <img id="hearts-header"  src="/ratchelor/img/player/playerselecthearts.png"></img>
        <div id="ratchelor-intro-title">
          You are The Ratchelor, 
        </div>
        <div id="ratchelor-intro"> 
        A single rat looking for love. You will meet many rats and slowly choose who to keep, round after round, until you find true love.</div>
        </div>
        <div id="custom-character-row">
          {Array(4).fill("").map((_, idx) => 
            <CharacterImg 
              selected={(idx + 1) === this.props.playerIdx} 
              onClick={() => {this.props.changePlayerIdx(idx + 1); this.setState({ratSelected: true});}}
