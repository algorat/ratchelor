...
class GameOptions extends React.Component {
  ...
  render() {
    ...
    return (
      <div id="game-options">
        <img src={soundurl} alt="Sound icon" className="sound-icon" onClick={toggleSound}/>
        ...
        <div className="behind-slider" style={{backgroundImage: `linear-gradient(to right, #fffec6, #fffec6 ${prog}%, #977c40 ${prog}%, #977c40 100%)`}}/>
        </div>
      </div>
    )
  }
